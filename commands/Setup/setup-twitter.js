    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://redmibot.es/')
...
/**
 * @INFO
 * Bot Coded by Mike | https://github?.com/MilratoDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
